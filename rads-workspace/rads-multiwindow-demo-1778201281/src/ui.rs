...
pub const APP_ID: &str = "dev.trueos.rads-multiwindow-demo-1778201281";
pub const APP_DISPLAY_NAME: &str = "RADS Multiwindow Demo 1778201281";
...
pub const WINDOW_1_MODEL: &str = include_str!("../ui/windows/settingswindow.ui2.json");
pub const WINDOW_1_HTML: &str = include_str!("../ui/windows/settingswindow.html");
pub const WINDOW_1_CSS: &str = include_str!("../ui/windows/settingswindow.css");
...
pub fn create_window_0() -> Option<vui2::OwnedWindow> {
    ...
    let window = vui2::OwnedWindow::create("RADS Multiwindow Demo 1778201281", rect)?;
    let id = window.id();
    id.set_decorations(vui2::WindowDecorationMode::System);
    id.set_title("RADS Multiwindow Demo 1778201281");
    Some(window)
}
...
pub fn create_window_1() -> Option<vui2::OwnedWindow> {
    ...
    let window = vui2::OwnedWindow::create("Settings", rect)?;
    let id = window.id();
    id.set_decorations(vui2::WindowDecorationMode::System);
