...
pub fn on_listbox1_select() {
    v::vshell::line("select fired on listbox1");
}

pub fn on_menu1_ready() {
    v::vshell::line("ready fired on menu1");
}

pub fn on_toolbar1_ready() {
    v::vshell::line("ready fired on toolbar1");
}
