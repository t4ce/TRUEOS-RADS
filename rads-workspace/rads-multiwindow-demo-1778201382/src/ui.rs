...
pub const APP_ID: &str = "dev.trueos.rads-multiwindow-demo-1778201382";
pub const APP_DISPLAY_NAME: &str = "RADS Multiwindow Demo 1778201382";
...
pub fn create_window_0() -> Option<vui2::OwnedWindow> {
    ...
    let window = vui2::OwnedWindow::create("RADS Multiwindow Demo 1778201382", rect)?;
    let id = window.id();
    id.set_decorations(vui2::WindowDecorationMode::System);
    id.set_title("RADS Multiwindow Demo 1778201382");
    Some(window)
}
